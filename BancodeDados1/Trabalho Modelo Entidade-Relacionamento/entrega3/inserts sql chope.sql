...
INSERT INTO PEDIDO(ID_PED,QUANTIDADE, DATA_PED,PAGAMENTO,CRACHA,CRACHA_ENTREGADOR,ID_CLI) VALUES 
(1,80,'2002/06/20', 'CARTAO CREDITO',20,10,5),
(2,30,'2002/06/21','DINHEIRO'		,24,10,100),
(3,30,'2002/06/20', 'CARTAO DEBITO' ,20,12,1),
(4,80,'2002/06/20', 'DINHEIRO'      ,20,14,9),
(5,50,'2002/06/20', 'DINHEIRO'      ,22,16,6),
(6,80,'2002/06/20', 'CARTAO CREDITO',20,18,8),
(7,100,'2002/06/22' ,'DINHEIRO'     ,20,16,108),
(8,20,'2002/06/20' ,'DINHEIRO'		,21,14,105),
(9,80,'2002/06/21' ,'DINHEIRO'		,20,10,103),
(10,50,'2002/06/25' ,'DINHEIRO'		,20,18,104);
